...
public class Personal_data_Adapter_Top extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public Personal_data_Adapter_Top(Context context) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            textView=itemView.findViewById(R.id.tv_personal_name);
        }
    }
}
