...
import com.fanwang.demo_doctor.adapter.CommentExpandAdapter;
import com.fanwang.demo_doctor.bean.CommentBean;
import com.fanwang.demo_doctor.bean.CommentDetailBean;
import com.fanwang.demo_doctor.bean.Data_item;
import com.fanwang.demo_doctor.commonality.Populace_Activity;
import com.fanwang.demo_doctor.commonality.TitleBackFragment;
import com.fanwang.demo_doctor.custom.CommentDialog;
import com.fanwang.demo_doctor.custom.CommentExpandableListView;
...
public class Leave_Massage extends Populace_Activity {
    ...
    public void initView() {
        titleBackFragment = new TitleBackFragment().newInstance("留言板", "#23b1a5");
    ...
    @OnClick({R.id.detail_page_do_comment, R.id.but_show_health})
    public void Onclick(View view) {
        switch (view.getId()) {
            case R.id.detail_page_do_comment:
                showCommentDialog_a();
                break;
            case R.id.but_show_health:
