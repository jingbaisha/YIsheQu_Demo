...
public class Service_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Service_Adapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.service_packge_adapter, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.textView.setText("在售" + data[position]);
